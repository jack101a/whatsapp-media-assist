...
function Options() {
  ...
  const [serverTemplates, setServerTemplates] = useState<{id: string; name: string; category: string; payload: Record<string, unknown>}[]>([]);
  ...
  useEffect(() => { void Promise.all([
    ...
    if (status.signedIn) {
      void billingRequest<{id: string; name: string; category: string; payload: Record<string, unknown>}[]>({ type: 'billing:get-templates' })
